...
export default function Allveggies() {
  return (
    <div>
      <div class="row">
        <div class="col-lg-4 col-md-5 col-sm-7">
          <div class="footer-link mt-50">
            <div class="card" style={{ width: "18rem" }}>
              <img
                src="/dist/images/boxes/veggies/small.png"
                class="card-img-top"
                alt="..."
              />
              <div class="card-body">
                ...
                <p class="card-text">
                  Get 5-8 lbs of amazing veggies delivered right to your
                  doorstep everyweek. Always FRESH. <br />
                </p>
                <Link
                  to="/checkout-small-veggies"
        ...
        <div class="col-lg-4 col-md-5 col-sm-7">
          <div class="footer-link mt-50">
            <div class="card" style={{ width: "18rem" }}>
              <img
                src="/dist/images/boxes/veggies/medium.png"
                class="card-img-top"
                alt="..."
              />
              <div class="card-body">
                ...
                <p class="card-text">
                  Get 9-11 lbs of amazing veggies delivered right to your
                  doorstep everyweek. Always FRESH. <br />
                </p>
                <Link
                  to="/checkout-medium-veggies"
                  class="btn btn-primary mt-15"
                >
                  I want this
                </Link>
        ...
        <div class="col-lg-4 col-md-5 col-sm-7">
          <div class="footer-link mt-50">
            <div class="card" style={{ width: "18rem" }}>
              <img
                src="/dist/images/boxes/veggies/large.png"
                class="card-img-top"
                alt="..."
              />
              <div class="card-body">
