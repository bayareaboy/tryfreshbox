...
class FruitsVeggiesMix extends Component {
  render() {
    return (
      <div>
        <section id="FruitsVeggiesMix">
          <div className="container mt-150">
            <div class="row">
              <div class="col-sm-8">
                <img
                  src="/dist/images/showcase/boximage5.jpeg"
...
export default FruitsVeggiesMix;
