...
class SnacksMini extends Component {
  render() {
    return (
      <div>
        <section id="SnacksMini">
          <div className="container mt-150">
            <div class="row">
              <div class="col-sm-8">
                <img
                  src="/dist/images/showcase/snacks/clifbar.jpg"
                ...
                <p className="description">
                  Mini Snack box full of amazing snacks great for 1 person.
                </p>
                <br />
                <h5>What's included:</h5>
                <ul>
                  <li>5pc Nature Valley Sweet & Salty Almond Bars </li>
                  <li>3pc CLIF Bar Crunchy Peanut Butter Energy Bars</li>
                  <li>7pcs Variety Pack of Chips</li>
                </ul>
                <hr />
              </div>
              {
              ...
              <div class="col-sm-4">
                <h4 className="product-title">
                  <span className="pricetag-title">Snacks Mini Pack</span>
                </h4>
                <hr />
