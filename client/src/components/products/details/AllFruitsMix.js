...
class AllFruitsMix extends Component {
  render() {
    return (
      <div>
        <section id="AllFruitsMix">
          <div className="container mt-150">
            <div class="row">
              <div class="col-sm-8">
                <img
                  src="/dist/images/showcase/fruits-large.jpg"
