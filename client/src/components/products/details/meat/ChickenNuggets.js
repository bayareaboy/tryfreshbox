...
class ChickenNuggets extends Component {
  render() {
    return (
      <div>
        <section id="ChickenNuggets">
          <div className="container mt-150">
            <div class="row">
              <div class="col-sm-8">
                <img
                  src="/dist/images/showcase/meat/nuggets.png"
                  alt="tryfreshbox.com"
                />
                <hr />
                <p className="pricetag ">About product</p>
                <br />
                <p className="description">Halal Chicken Nuggets 10 LB.</p>
                <br />
                <h5>What's included:</h5>
                <ul>
                  <li>1 Box of Uncooked Halal Chicken Breast Nuggets 10 LB</li>
                </ul>
                <hr />
              </div>
              {
              ...
              <div class="col-sm-4">
                <h4 className="product-title">
                  <span className="pricetag-title">
                    Uncooked Halal Chicken Breast Nuggets 10 LB
                  </span>
                </h4>
                <hr />
