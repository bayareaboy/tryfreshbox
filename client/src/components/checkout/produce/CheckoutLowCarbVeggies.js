...
import PaymentsSmall from "../payments/PaymentsSmall";
class CheckoutLowCarbVeggies extends Component {
  constructor(props) {
    super(props);
    this.state = {
      complete: false,
  ...
  render() {
    if (this.state.complete) return <PaymentsSmall />;
    return (
      <div>
            ...
            <div className="col-md-4 order-md-2 mb-4">
              ...
              <ul className="list-group mb-3">
                <li className="list-group-item d-flex justify-content-between lh-condensed">
                  <div>
                    <h6 className="my-0">Freshbox Low Carb Veggies Mix</h6>
...
export default CheckoutLowCarbVeggies;
