...
import PaymentsMedium25 from "../payments/PaymentsMedium25";
class CheckoutLowCarbFruits extends Component {
  constructor(props) {
    super(props);
    this.state = {
      complete: false,
      ...
      deliveryTime: "",
      frequency: "",
      boxType: "low carb fruits and veggies mix "
    };
  ...
  render() {
    if (this.state.complete) return <PaymentsMedium25 />;
    return (
      <div>
            ...
            <div className="col-md-4 order-md-2 mb-4">
              ...
              <ul className="list-group mb-3">
                <li className="list-group-item d-flex justify-content-between lh-condensed">
                  <div>
                    <h6 className="my-0">
                      Freshbox Low Carb Fruits and Veggies Mix
                    </h6>
...
export default CheckoutLowCarbFruits;
