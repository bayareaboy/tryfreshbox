...
import PaymentsLarge from "../payments/PaymentsLarge";
import { Link } from "react-router-dom";

class CheckoutFruitsVeggiesMix2 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      complete: false,
      ...
      deliveryTime: "",
      frequency: "",
      boxType: "fruits and veggies mix 2"
    };
  ...
  render() {
    if (this.state.complete) return <PaymentsLarge />;
    return (
      <div>
            ...
            <div className="col-md-4 order-md-2 mb-4">
              ...
              <ul className="list-group mb-3">
                <li className="list-group-item d-flex justify-content-between lh-condensed">
                  <div>
                    <h6 className="my-0">Freshbox Fruits and Veggies Mix</h6>
...
export default CheckoutFruitsVeggiesMix2;
